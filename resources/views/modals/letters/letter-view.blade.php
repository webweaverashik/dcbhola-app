        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewLetterLabel">
                    ...
                    <span class="shadow-none badge badge-primary d-none" id="statusNew">নতুন</span>
                    <span class="shadow-none badge badge-warning d-none" id="statusProcessing">প্রক্রিয়াধীন</span>
                    <span class="shadow-none badge badge-success d-none" id="statusCompleted">নিষ্পন্ন</span>
                </h5>
