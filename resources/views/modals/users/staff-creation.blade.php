...
<div class="modal modal-lg fade" id="addOfficerModal" tabindex="-1" role="dialog" aria-labelledby="addOfficerLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="section general-info" action="{{ url('users/add/2') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="info">
                        <div class="row">
